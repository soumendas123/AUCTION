...
body
{
	background:url('<?php echo base_url();?>isolated-2532037__340.png');
...
<div id="div1">
<div id="div2">
<a href="<?php echo base_url();?>index.php/Auction" id="a1"><img src="<?php echo base_url();?>imahaaa.png" height="120px" width="130px" class="img2"></a>
</div>
ONLINE AUCTION
</div>
<center>
